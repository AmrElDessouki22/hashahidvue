<template>
    <div class="parent">
    <h2 style="color:white;text-align: start;margin:50px">English Series</h2>
...
export default {
  ...
  methods: {
    getposterimg: async function () {
      const response = await fetch('https://xspot.herokuapp.com/getenglishgetseries?skip=0&limit=4', {
        method: 'GET'
      })
